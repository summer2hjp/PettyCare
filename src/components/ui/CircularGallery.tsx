...
class App {
  ...
  isDown = false;
  start = 0;
  scroll: { ease: number; position: number; current: number; target: number; last: number };
  ...
  onWheel(e: WheelEvent) {
    const wd = (e as unknown as Record<string, number>).wheelDelta;
    const dt = (e as unknown as Record<string, number>).detail;
    const delta = e.deltaY || wd || dt;
