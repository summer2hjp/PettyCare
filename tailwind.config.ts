    ...
    extend: {
      ...
      colors: {
        apple: {
          ...
          secondarySystemGroupedBackground: 'var(--apple-secondarySystemGroupedBackground)',
          tertiarySystemGroupedBackground: 'var(--apple-tertiarySystemGroupedBackground)',
          fill: 'var(--apple-fill)',
          secondaryFill: 'var(--apple-secondaryFill)',
          tertiaryFill: 'var(--apple-tertiaryFill)',
          quaternaryFill: 'var(--apple-quaternaryFill)',
